...
```{r}
# Empleando la información que se nos da en el enunciado realizamos la distribución
# Primero establecemos el rango de representación de la distribución
x<-seq(0,8,length.out=500)
dis1<-dnorm(x,mean=2,sd=1)
dis2<-dnorm(x,mean=5,sd=1)
distribucion_conjunta<- dis1*0.3+(1-0.3)*dis2
plot(x,distribucion_conjunta,type='l',col='blue',main='Visualización de la distribución de mezcla gaussiana')
```
