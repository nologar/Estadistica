...
```
Procedemos ahora con el estudio previamente explicado: 
...
plot(freq_axis,mod_tf_season, type = "lo")
```
...
tf_season[order(mod_tf_season, decreasing= TRUE)[1:2] ]<- tf_season[which.max(mod_tf_season)]
plot(freq_axis,tf_season, xlab = "Frecuencia", ylab = "Amplitud")
```
...
par(mfrow = c(3,1))
plot(df_hasta_2010$time, df_hasta_2010$seasonal, main = "Estacionalidad original", xlab = "Año", ylab = "Temperatura (10 * Cº)", type = "l")
plot(df_hasta_2010$time, season_guess, main = "Estacionalidad predicha", xlab = "Año", ylab = "Temperatura (10 * Cº)", type = "l")
plot(df_hasta_2010$time, abs( df_hasta_2010$seasonal - season_guess), main = "Diferencia", xlab = "Año", ylab = "Temperatura (10 * Cº)", type = "l")
```
