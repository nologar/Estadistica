...
```{r ej81, echo=FALSE}
time_desde_2009_hasta_2030 <- seq(2009, 2030 + 2/36, by = 1/36)               # Vector de tiempos desde 2009 para que haya un poco de solapamiento
time_desde_2009_hasta_2024 <- seq(2009, 2024 + 2/36, by = 1/36)

#predictor <- data.frame(time_desde_2009_hasta_2030)
predictor <- data.frame(time_desde_2009_hasta_2030)

trend_guess_desde_2009_hasta_2030 <- predict(modelo_tendencia, newdata=predictor, interval = "confidence")
...
plot(time_desde_2009_hasta_2030, ts_guess_2_desde_2009_hasta_2030, type = "l", main = "", col = "blue", xlab = "Tiempo", ylab = "Temperatura (Cº/10)")
...
plot(time_desde_2009, ts_guess_2_desde_2009, type = "l", main = "Predicción",xlab = "Tiempo", ylab = "Temperatura (Cº/10)")
plot(seq(2009, 2024 + 2/36, by = 1/36) ,ts_original_desde_2009, type = "l", main= "Original",xlab = "Tiempo", ylab = "Temperatura (Cº/10)")
plot(time_desde_2009 ,abs(ts_original_desde_2009-ts_guess_2_desde_2009) , type = "l", main= "Diferencia absoluta",xlab = "Tiempo", ylab = "Temperatura (Cº/10)")
```
