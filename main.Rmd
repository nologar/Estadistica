...
ts_guess_desde_2009 <- trend_guess_desde_2009 + seasonal_guess_1_desde_2009
...
plot(time_desde_2009 ,abs(ts_original_desde_2009-ts_guess_desde_2009) , type = "l", main= "Diferencia absoluta",xlab = "Tiempo", ylab = "Temperatura (Cº/10)")
...
ts_guess_desde_2009 <- trend_guess_desde_2009 + seasonal_guess_2_desde_2009
...
Vemos que la estacionalidad que hemos predicho se ajusta correctamente a la estacionalidad original.
...
Notamos que desde el 2010-01-01 hasta el fin de la toma de medidas ( 2024-01 incluido ) transcurren un total de

$(2023 - 2010 - 1)*12 + 1 = 145 $ meses, y por tanto, se corresponde a $145 * 3 = $ observaciones.

Por lo tanto, el vector que tendremos que generar tendra está medida.
